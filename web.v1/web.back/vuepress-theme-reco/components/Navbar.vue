  ...
  <header class="navbar">
    ...
    <router-link :to="$localePath" class="home-link">
      <img
        ...
        :alt="$siteTitle"
      />
      <span ref="siteName" class="site-name" v-if="$themeConfig.titlePage">{{
        $themeConfig.titlePage
      }}</span>
      <span ref="siteName" class="site-name" v-else>{{ $siteTitle }}</span>
    </router-link>
    ...
    setup(props, ctx) {
      ...
      onMounted(() => {
        ...
        const NAVBAR_VERTICAL_PADDING =
          parseInt(css(instance.$el, 'paddingLeft')) + parseInt(css(instance.$el, 'paddingRight'));

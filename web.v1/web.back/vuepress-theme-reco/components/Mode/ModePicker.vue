<template>
  <div class="mode-options">
    ...
    <ul class="color-mode-options">
      ...
      >
        <span class="iconify" :data-icon="mode.icon"> </span>
      </li>
    </ul>
  </div>
</template>
...
export default {
  ...
  data() {
    return {
      modeOptions: [
        { mode: 'dark', title: 'dark', icon: 'bxs:moon' },
        { mode: 'auto', title: 'auto', icon: 'ic:baseline-brightness-auto' },
        { mode: 'light', title: 'light', icon: 'bxs:sun' },
      ],
      currentMode: 'auto',
    };
  },

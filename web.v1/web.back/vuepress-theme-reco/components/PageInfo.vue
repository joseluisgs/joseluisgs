<template>
  <div>
    ...
    <div class="page-info">
      ...
      <reco-icon v-if="pageInfo.readingTime" icon="reco-eye">
...
<script>
  ...
  export default defineComponent({
    ...
    setup(props, ctx) {
      ...
      // tiempo de lectura
      const readingTime = Math.ceil(props.pageInfo.readingTime.minutes) + ' min.';

      return { numStyle, goTags, formatDateValue, readingTime };
    },
  });
</script>

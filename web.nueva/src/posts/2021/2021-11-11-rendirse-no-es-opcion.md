...
Al vivir en el mundo de la inmediatez y de un solo clic, queremos suprimir las dos primeras etapas y codificar todo sin parar a analizar para luego diseñar la solución. Pero es que programar no solo es codificar en un lenguaje, es descomponer un problema en pasos, una serie de sentencias, estructuras, objetos, usar librerías... No se trata de escribir por escribir.
...
Para terminar te dejo un ejemplo de superación de adversidades. Como me gusta mucho la guitarra y el rock, Tommy Iommi es ejemplo de no darse por vencido y buscar soluciones para llegar a tu meta, y de paso convertirse en un pionero. Te invito a que conozcas su historia.

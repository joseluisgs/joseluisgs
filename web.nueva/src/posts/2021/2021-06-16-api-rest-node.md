...
Divídela por capas, usa por ejemplo el patrón MVC, que en NodeJS ofrece una arquitectura de fácil implementación y extensión de tu problema. Rutas 100% RESTful, usa los verbos HTTP para realizar todas tus operaciones. Patrón de operaciones CRUD sobre recursos: podrás añadir, listar, modificar o eliminar. Sube tus ficheros a tu servidor. Todo almacenando usando MongoDB.
...
::: warning Atención
Este proyecto tiene algo de antigüedad y puede que las librerías estén en desuso. Te recomiendo que eches un ojo en [TypeScript API REST](#typescript-api-rest) porque, siguiendo esta misma filosofía, puedes ver una versión más moderna en el uso de librerías, organización de código y distintas versiones de persistencia de la información.
:::

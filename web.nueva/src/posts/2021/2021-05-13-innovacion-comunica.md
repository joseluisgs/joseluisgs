...
Todos los puntos se espera conseguir no solo creando un entorno favorable, sino con la participación y colaboración de todos los profesores implicados en el proyecto.
...
- ***Establecer mecanismos de desarrollo colaborativo entre alumnado de distintos ciclos*** simulando una empresa software con distintas sedes.

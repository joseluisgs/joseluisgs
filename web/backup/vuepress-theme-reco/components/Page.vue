  ...
  <main class="page" :style="pageStyle">
    <ModuleTransition>
      <div v-if="recoShowModule && $page.title" class="page-title">
        ...
        <img v-if="$page.frontmatter.image" :src="$page.frontmatter.image" alt="Image noticia">
      </div>
    </ModuleTransition>
    ...
    <ModuleTransition delay="0.16">
      <footer v-if="recoShowModule" class="page-edit">
        ...
        >
          ...
          <!-- <span class="time">{{ this.$page.lastUpdated }}</span> -->
        ...
        <span class="time"><a href="https://forms.gle/V2m42qiW1s6X4oNt8" target="_blank">¿Algún error?</a></span>
        </div>
      </footer>
    </ModuleTransition>

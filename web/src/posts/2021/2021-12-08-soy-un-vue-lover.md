...
### Otros
Seguro que me dejo muchos de los increíbles proyectos como [VeeValidate](https://vee-validate.logaretm.com/v4/), [VueUse](https://vueuse.org/) o [Slidev](https://sli.dev/), pero te invito a que mires [VueAwesome](https://github.com/vuejs/awesome-vue) y conozcas los proyectos alrededor de Vue.js.
...
### Testing
Para testear nada mejor que [Cypress](https://www.cypress.io/blog/2021/04/06/getting-start-with-cypress-component-testing-vue-2-3/) y/o Jest usando [Vue Test Utils](https://vue-test-utils.vuejs.org/). En esta entrada te explico cómo testar componentes y aplicaciones Vue.js.

...
description: Un ejemplo de todo lo visto en Programación Multimedia y Dispositivos Móviles de 2.º DAM
date: 2021-05-12
category:
  - Proyectos
  - Docencia
...
Finalmente, se han ido aplicando distintas tecnologías con el objetivo de abrir las puertas en el desarrollo móvil al alumnado y con ello sean capaces de dominar los aspectos más destacados de las mismas para después desarrollar sus propias *apps*.
...
en sistemas Android usando el lenguaje Kotlin. Podrás llevar tus momentos favoritos siempre en tu móvil.
...
- **v1.0.0**: Versión donde el almacenamiento de todos los datos se hace de manera local usando una base de datos [Realm](https://realm.io/).
  ...
  la base de datos y no es muy recomendado salvo excepciones como esta. Se puede ver una versión alternativa almacenando las imágenes en sistemas de almacenamiento interno y externo.
...
- [API REST](https://www.bbvaapimarket.com/es/mundo-api/api-rest-que-es-y-cuales-son-sus-ventajas-en-el-desarrollo-de-proyectos/#:~:text=En%20el%20campo%20de%20la,a%20partir%20de%20ese%20software.)
...
perfectamente. Te recomiendo que sigas siempre la guía oficial de [Firebase](https://firebase.google.com/docs/android/setup?hl=es)
...
de cómo se desarrolla este tipo de servicios, sino solo de consumirlo y usarlo en tu *app* móvil.

Para ello es fundamental tener instalado en tu sistema operativo [Node.js](https://nodejs.org/es/).
...
Esta pequeña aplicación que simula un servidor de API REST está probada en *Linux* y *OS X*. Si la vas a usar en *Windows*, por favor
asegúrate de que los *scripts* de NPM son compatibles y las rutas de tu sistema.
...
Los mapas hacen uso de *Google Map Api Key*, es por ello que debes activar la clave de la API y activarla para tu proyecto,
...
se debe generar con *keytool* la huella SHA-1 con los datos del paquete *release*, crear un proyecto y subirla a

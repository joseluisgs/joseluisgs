...
Espero que vaya bien. Comenzamos con... 🙂 
...
Ahora, creo que es el momento de recuperarla poniendo en práctica distintas tecnologías y usarla como ejemplo con mi alumnado para tratar distintos temas: 
- [Vue.js](https://vuejs.org/) y desarrollo *frontend* con JavaScript.
...
- [*Server Side Rendering*](https://ssr.vuejs.org/) con Vue.js y [VuePress](https://vuepress.vuejs.org/).
...
Como se puede ver, aparte de una web personal, es un ejemplo de diversas tecnologías que uso a nivel docente o a nivel particular y que se pueden usar como ejemplos. Este ha sido mi verdadero objetivo con esta web. De hecho, todo el código siempre estará disponible en mi [repositorio](https://github.com/joseluisgs).

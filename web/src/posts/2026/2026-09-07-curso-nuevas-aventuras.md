---
title: "Curso nuevo, nuevas aventuras"
description: Arranca el curso 2026/2027 con nuevos retos en FP, universidad
date: 2026-09-07
category:
  - Blog
  - Docencia
...
cover: https://i.imgur.com/m25wDVK.jpg
comment: true
sidebar: false
footer: true
---
...
```mermaid
graph TD
    A[Alumno usa IA sin bases] --> B[Copia solución]
    B --> C[No entiende por qué funciona]
    C --> D[No puede adaptarla a otro contexto]
    D --> E[Genera deuda técnica]
    E --> F[Código frágil, no testeable, no escalable]
    F --> G[Coste de mantenimiento por las nubes]

...
[
      "meta",
      {
        name: "keywords",
        content:
          "Profesor Informática, FP, Ciclos Formativos, Cursos de Especialización, Formador Kotlin Certificación JetBrains, Desarrollador Full Stack, Backend, Docente Desarrollo Web, C# .NET, ASP.NET Core, Blazor, Entity Framework Core, Programación Orientada Objetos, POO, Testing Unitarios, TDD, Docker, Microservicios, REST API, JWT, Clean Code, SOLID, GitHub, Leganés Madrid, DAW Desarrollo Aplicaciones Web, DAM Desarrollo Aplicaciones Multiplataforma, Formación Profesional, Instituto IES Luis Vives, Universidad Carlos III de Madrid, UC3M, Profesor Universidad, Grado Informática, Desarrollo de Software, Arquitectura de Datos, Doctor en Informática",
      },
    ],
